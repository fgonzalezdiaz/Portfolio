...
export function InfoBoxVerticalImg({ text, image, gitLink }) {
    return (
        <div className='InfoBoxVerticalImg'>
            ...
            <p className='text-InfoBoxXL'>{text}</p>
            <Link to={gitLink}><InfoBoxMVerticalImg text={<p>Click here to find the repository</p>} image="/github-logo.png" image2="/github-logo.png" /></Link>
        </div>
    )
}
...
export function InfoBoxVerticalImgTwoRepositories({ text, image, gitLink1, gitLink2 }) {
    return (
        <div className='InfoBoxVerticalImg'>
            <img src={image} className='img-InfoBoxXL' alt="Imagen" style={{ marginTop: '20px', marginBottom: '20px' }} />
            <p className='text-InfoBoxXL'>{text}</p>
            <Link to={gitLink1}><InfoBoxMVerticalImg text={<p>Repository SpringBoot JDCB</p>} image="/github-logo.png" image2="/github-logo.png" /></Link>
            <Link to={gitLink2}><InfoBoxMVerticalImg text={<p>Repository SpringBoot JPA</p>} image="/github-logo.png" image2="/github-logo.png" /></Link>
        </div>
    )
}
